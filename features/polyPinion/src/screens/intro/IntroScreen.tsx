...
function IntroHeader({ questionnaire }) {
    ...
    return (
        <BigHeader>
            ...
            <h1>{t(questionnaire.title).toUpperCase()}</h1>
            <p>
                {`${t("intro.published")}: `}
...
function ActionButtons({ questionnaire }) {
    return (
        <CenteredFooter>
            <StartSurveyButton questionnaire={questionnaire} route="/survey" />
        </CenteredFooter>
    );
...
function Description({ questionnaire }) {
    ...
    return <p>{t(questionnaire.description)}</p>;
}
...
const IntroScreen = function () {
    ...
    return (
        <Layout
            header={<IntroHeader questionnaire={questionnaire} />}
            footer={<ActionButtons questionnaire={questionnaire} />}
        >
            <main>
