        ...
        survey: {
            screen_answers: {
                ...
                description_before_submit:
                    "Here you can review your answers before submitting them. You're always welcome to change your mind before doing so.",
            ...
            error: {
                ...
                message:
                    "Thank you for taking part in the survey. Unfortunately an error occurred while submitting your answers. Please try again later.",
            },
        },
        analytics: {
            alert: {
                ...
                description:
                    "App crash analytics help us understand when something goes wrong and sends anonymous reports to us so we can deliver a better app in future versions.",
                no_option: "No thanks",
            },
            preferences: {
                action: "Enable Analytics",
                description:
                    "Crash Reporting analytics help us fix bugs and improve the app. This data is collected in accordance to our Data Collection policy and you can opt out of it anytime.",
            },
        },
        onboarding: {
            screen_03: {
                main_message_02:
                    "Aggregated results are released after the survey period has ended on the website of our partners in secure data collection for better decisions as a society in transition.",
                button: {
            ...
            screen_01: {
                ...
                main_message:
                    "The polyPod is a secure way for you to share data. It delivers surveys that cover lots of different topics. The questions and answers are designed to fully respect your privacy.",
            },
            screen_04: {
                message:
                    "<1>polypoly</1> is on a mission to make data more secure and personal. Our solutions are Private by Design and user-centric in the most basic sense.\nThe <3>polyPod</3> is polypoly's core product.",
                button: {
                    continue: "Continue",
                },
            },
            screen_02: {
                ...
                main_message:
                    "New surveys will be released every month and should take around five minutes of your time.\nMore participants creates a better picture about what the European community cares about.",
            },
            collected_data: "What data is collected?",
            analytics: {
                title: "Help us improve the app",
                details:
                    "App crash analytics help us understand when something goes wrong and sends anonymous reports to us, helping us improve the app.",
            },
        },
        general: {
