  ...
  */
  ...
  var exampleData = {
      ...
      Ruth: [
          ...
          {
              sender: "Ruth",
              content: "What's up? How've you been?",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "self",
          ...
          {
              sender: "Ruth",
              content: "Hey, Conversation",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "self",
              content: "Oh, right. I'm fine. You?",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
      ],
      Sam: [
          ...
          {
              sender: "Sam",
              content: "Michael. Good to meet you!",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "self",
          ...
          {
              sender: "Sam",
              content: "Yeah, We arrived last week.",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "self",
          ...
          {
              sender: "self",
              content: "Yes, I am married and I have two children.",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "Sam",
          ...
          {
              sender: "self",
              content: "6 and 8 years old",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "Sam",
              content: "Oh, great. That age is a lot of fun.",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "self",
              content: "But it is exhausting.",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
          {
              sender: "Sam",
          ...
          },
          {
              sender: "self",
              content:
                  "Must be nice. We don’t have time to sleep, we have to drink a lot of coffee.",
              date: "Thu Jun 02 2022 15:20:30 GMT+0200 (Central European Summer Time)",
          },
      ],
  };
  ...
  const MessagesContextProvider = ({ children }) => {
      ...
      const [activeMessageThread, setActiveMessageThread] = React.useState(null);
              ...
              , React__default["default"].createElement(ConversationList, null
                  , Object.entries(rooms).map(([name, room], i) => (
                      React__default["default"].createElement(Conversation, {
                          ...
                          , React__default["default"].createElement(Avatar, { src: `images/${name}.png`, name: "Thorsten",} )
                      )
                  ))
              )
          )
  ...
  const Room = () => {
      const { activeRoom, activeMessageThread, handleSendMessage } =
      ...
      function groupMessages() {
          const messages = activeMessageThread;
          const messageGroups = [];
      ...
      return (
          React__default["default"].createElement(polyLook.Screen, { className: "poly-theme-light room" ,}
              , React__default["default"].createElement(ConversationHeader, null
                  , React__default["default"].createElement(Avatar, { src: `images/${activeRoom.name}.png`, name: "Thorsten",} )
      ...
      return (
          React__default["default"].createElement(MemoryRouter, { history: history,}
              , React__default["default"].createElement(MessagesContextProvider, null
                  ...
                  , React__default["default"].createElement(Messenger, null )
              )
          )
      );
  };
  ...
  //render to html
  ReactDOM__namespace.render(React__default["default"].createElement(MessengerApp, null ), document.getElementById("feature"));
