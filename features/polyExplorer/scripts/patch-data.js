const patchData = {
    "About YOU GmbH (DE)": {
        description: {
            value: {
                de:
                    "Die About You GmbH (Eigenschreibweise ABOUT YOU) ist ein deutscher Internethändler für Bekleidung, Schuhe und Accessoires mit Sitz in Hamburg. Die About You GmbH wurde als Tochtergesellschaft von Otto gegründet und wird seit 2018 als Beteiligungsgesellschaft im Konzernportfolio geführt.\n\n        Das Unternehmen betreibt die deutschen Onlineshops aboutyou.de und edited.de sowie die About-You-Shopping-App und ist mit parallelen Angeboten in 18 weiteren europäischen Ländern aktiv. Die GmbH entstand im Mai 2014; gleichzeitig wurde auch die Marke About You eingetragen. Seit der Gründung arbeitet About You mit Influencern zusammen und verkauft neben Fremdmarken auch Eigenmarken. Die Eigenmarke Edited wird auch im stationären Handel angeboten.\n\n        2018 gehörte About You in Deutschland zu den fünf umsatzstärksten Onlinehändlern im Segment Bekleidung.",
            },
    ...
    "Axel Springer SE (DE)": {
        description: {
            value: {
                de:
                    "Die Axel Springer SE ist eine Verlagsgruppe mit mehreren multimedialen Marken wie Bild, Die Welt, Welt (Fernsehsender, früher N24), Business Insider oder Fakt. Seit 2020 befindet sich das Unternehmen mehrheitlich in der Hand der US-amerikanischen Beteiligungsgesellschaft KKR.\n\n        Das Unternehmen hat seinen Sitz im Axel-Springer-Haus in Berlin und ist mit Tochtergesellschaften, Joint Ventures und Lizenzen in mehr als 40 Ländern aktiv. Das Geschäft von Axel Springer ist in die vier operativen Segmente Anzeigenplattformen (Classifieds Media), Inhalteerstellung und -finanzierung (News Media), Vermarktung (Marketing Media), sowie das Segment Services/Holding aufgeteilt. Im Geschäftsjahr 2019 erwirtschafteten etwa 16.120 Mitarbeiter einen Konzernumsatz von etwa 3,1 Mrd. Euro. Digitale Aktivitäten tragen rund 73 % zum Umsatz bei.",
            },
            source: "Wikipedia, polyPedia",
        },
    },
    "BASF SE (DE)": {
        description: {
            value: {
                de:
                    "Die BASF SE mit Sitz in Ludwigshafen am Rhein ist ein börsennotierter Chemiekonzern. BASF beschäftigt weltweit 110.302 Mitarbeiter an über 390 Produktionsstandorten in mehr als 80 Ländern. 2020 wurde ein Umsatz von 59,149 Milliarden Euro erzielt; nach Umsatz ist es der größte Chemiekonzern weltweit. Das Unternehmen hat seinen Ursprung in der 1865 in Mannheim gegründeten Badischen Anilin- & Soda-Fabrik. Weil dort kein geeignetes Areal zur Verfügung stand, wurde das neue Werk noch im selben Jahr in Ludwigshafen gebaut.",
            },
            source: "Wikipedia, polyPedia",
        },
    },
    ...
    "Check24 Vergleichsportal GmbH (DE)": {
        description: {
            value: {
                de:
                    "Die Check24 GmbH (Eigenschreibweise CHECK24) ist eine 1999 gegründete Unternehmensgruppe mit Sitz in München, die seit 2008 ein Preisvergleichsportal für die Bereiche Versicherungen, Finanzen, Energie, Telekommunikation, Reisen sowie Shopping betreibt und dabei sowohl als Makler als auch als Versicherungsvertreter tätig ist.",
            },
            source: "Wikipedia, polyPedia",
        },
    },
