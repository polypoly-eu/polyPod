(function (React, ReactDOM) {
  ...
  */
  ...
  const ImportView = () => {
      return React__default["default"].createElement('div', { className: "import-view",});
  };
  ...
  const Google = () => {
      ...
      return (
          React__default["default"].createElement('div', { className: "google poly-theme poly-theme-light"  ,}
              , pod ? (
                  React__default["default"].createElement(Switch, null
                      ...
                      , React__default["default"].createElement(Route, { exact: true, path: "/import",}
                          , React__default["default"].createElement(ImportView, null )
                      )
                  )
              ) : (
                  renderSplash()
  ...
  const GoogleApp = () => {
      ...
      return (
          React__default["default"].createElement(MemoryRouter, { history: history,}
              , React__default["default"].createElement(GoogleContextProvider, null
                  , React__default["default"].createElement('div', { className: "poly-nav-bar-separator-overlay",} )
                  , React__default["default"].createElement(Google, null )
              )
          )
      );
  };
  ...
  //render to html
  ReactDOM__namespace.render(React__default["default"].createElement(GoogleApp, null ), document.getElementById("feature"));
