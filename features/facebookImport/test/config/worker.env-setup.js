...
global.Worker = function Worker(url) {
    ...
    global
        // This is the main difference with the jsdom-worker package.
        // The Zip reader calls this with an URL as a paramerer.
        // TODO: Maybe better would be to check the type and handle both
        // URL and string, or check if Worker is only called with strings.
        .fetch(url.toString())
        .then((r) => r.text())
        .then((code) => {
