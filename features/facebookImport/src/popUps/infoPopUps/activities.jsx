            ...
            <div className="full-width">
                <Infographic
                    ...
                    texts={{
                        ...
                        boldJan: i18n.t(
                            "infographics:activitiesBarChart.boldJan"
                        ),
                        boldFeb: i18n.t(
                            "infographics:activitiesBarChart.boldFeb"
                        ),
                        boldMar: i18n.t(
                            "infographics:activitiesBarChart.boldMar"
                        ),
                        boldApr: i18n.t(
                            "infographics:activitiesBarChart.boldApr"
                        ),
                        boldMay: i18n.t(
                            "infographics:activitiesBarChart.boldMay"
                        ),
                        boldJun: i18n.t(
                            "infographics:activitiesBarChart.boldJun"
                        ),
                        boldJul: i18n.t(
                            "infographics:activitiesBarChart.boldJul"
                        ),
                        boldAug: i18n.t(
                            "infographics:activitiesBarChart.boldAug"
                        ),
                        boldSep: i18n.t(
                            "infographics:activitiesBarChart.boldSep"
                        ),
                        boldOct: i18n.t(
                            "infographics:activitiesBarChart.boldOct"
                        ),
                        boldNov: i18n.t(
                            "infographics:activitiesBarChart.boldNov"
                        ),
                        boldDec: i18n.t(
                            "infographics:activitiesBarChart.boldDec"
                        ),
                    }}
                />
            </div>
