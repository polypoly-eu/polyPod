...
import messengesMinistoryEn from "./locales/en/ministories/messages.json";

import commonDe from "./locales/de/common.json";
import importDe from "./locales/de/import.json";
import overviewDe from "./locales/de/overview.json";
import messengesMinistoryDe from "./locales/de/ministories/messages.json";
...
export default new I18n(determineLanguage(), {
    en: {
        ...
        import: importEn,
        overview: overviewEn,
        messengesMinistory: messengesMinistoryEn,
    },
    de: {
        common: commonDe,
        import: importDe,
        overview: overviewDe,
        messengesMinistory: messengesMinistoryDe,
    },
});
