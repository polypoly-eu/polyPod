var Feature = (function () {
	...
	*/
	...
	class PodSpec {
	    ...
	    polyIn() {
	        ...
	        describe("polyIn", () => {
	            ...
	            describe("factory", () => {
	                new index_es.DataFactorySpec(polyIn.factory).run();
	            });
	            ...
	            it("add/select", async () => {
	                const {triple} = index_es.gens(polyIn.factory);
	        ...
	        describe("polyOut", () => {
	            ...
	            describe("HTTP requests", () => {
	                ...
	                it("Successful POST", async () => {
	                    ...
	                    chai$1.assert.property(json, "data", postBody);
	                    chai$1.assert.property(json, "method", "POST");
	                });
	...
	var index = /*@__PURE__*/unwrapExports(specs);
	...
	function setupMocha() {
	    ...
	    results.setAttribute("id", "mocha");

	    const harness = document.getElementById("feature");
	    harness.innerHTML = "";
	    harness.appendChild(results);
	}

	function setupTests(pod) {
