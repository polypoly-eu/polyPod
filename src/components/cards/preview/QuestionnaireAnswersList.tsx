                    ...
                    .map((item) => {
                        ...
                        switch (item.constructor) {
                            case PpTextQuestion:
                                ...
                                preview = <TextQuestionAnswerPreview question={item} />;
                                break;
                            case PpSingleChoiceQuestion:
                                preview = <SingleChoiceQuestionAnswerPreview question={item} />;
                                break;
                            case PpMultipleChoiceQuestion:
                                preview = <MultipleChoiceQuestionAnswerPreview question={item} />;
                                break;
                            case PpRangeQuestion:
                                preview = <RangeQuestionAnswerPreview question={item} />;
                                break;
                        }
