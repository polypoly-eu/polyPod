...
class PolyOutTest {
    ...
    init {
        polyOut = PolyOut(context = InstrumentationRegistry.getInstrumentation().targetContext)
    }
    ...
    fun importOneArchiveWorks() {
        ...
        val url = InstrumentationRegistry.getInstrumentation().javaClass.classLoader!!.getResource("testZip.zip").toString()
        val inputStream = InstrumentationRegistry.getInstrumentation().javaClass.classLoader!!.getResource("testZip.zip").openStream()
