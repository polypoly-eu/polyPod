...
export class DataFactorySpec<OutQuad extends BaseQuad = Quad> {
    /**
     * It creates a new instance of the class DataFactorySpec.
     * @param {DataFactory<OutQuad>} dataFactory
     */
    constructor(private readonly dataFactory: DataFactory<OutQuad>) {}

    /**
     * It tests that the `blankNode` method of the `DataFactory` class creates a `BlankNode` object with
    ...
    /**
     * It tests that the `defaultGraph` method of the `DataFactory` class returns an object with a
     * `termType` property that contains the value `"DefaultGraph"`, and a `value` property that contains
     * an empty string
     */
    defaultGraph(): void {
    ...
    /**
     * It tests the `literal` function of the `DataFactory` class
     */
    literal(): void {
        describe(".literal", () => {
            it("should be a static method", () => {
    ...
    /**
     * It tests that the `.namedNode` method of the `DataFactory` class creates a `NamedNode` object with
     * the correct properties
     */
    namedNode(): void {
        describe(".namedNode", () => {
    ...
    /**
     * It tests that the `.quad` method of the `DataFactory` class creates a quad with the given subject,
     * predicate, object and graph, and that the `.equals` method of the quad returns true if the other
     * quad contains the same subject, predicate, object and graph
     */
    quad(): void {
        describe(".quad", () => {
            it("should be a static method", () => {
    ...
    /**
     * It tests the `variable` method of the `DataFactory` interface
     */
    variable(): void {
    ...
    /**
     * It generates a test suite that checks that each term generator generates terms that are equal to
     * themselves, and that each term generator generates terms that are not equal to terms generated by
     * other term generators
     */
    gen(): void {
